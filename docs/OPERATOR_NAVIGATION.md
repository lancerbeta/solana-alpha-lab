...
- `ACTIVE-MARKET-DATA-AWARENESS` → `CONFIG-MARKET-CONTEXT-DEFINITION-001` (`CURRENT_AT_COMMIT`)
- `ACTIVE-OWNER-DAILY-ATTENTION` → `DOC-OWNER-ATTENTION-AND-CHANGE-FEED-001` (`CURRENT_AT_COMMIT`)
