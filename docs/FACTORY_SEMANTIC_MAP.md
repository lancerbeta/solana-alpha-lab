...
| How do I generate or review a hypothesis? | SEM-HYPOTHESIS-FORGE | ACTIVE-HYPOTHESIS-FORGE→CONFIG-HYPOTHESIS-FORGE-INDEPENDENT-CRITIC-001; DOC-HYPOTHESIS-FORGE-OPERATOR-001; SKILL-HYPOTHESIS-FORGE-001; CONTRACT-NORMALIZED-TRAJECTORY-V1-CAPABILITY-001 | CAPABILITY | resolve-route / Catalog dereference | false |
...
| How does live RDP get into Forge? | SEM-LIVE-EVIDENCE-TO-FORGE | ACTIVE-LIVE-LIFECYCLE-EVIDENCE→MODULE-LIVE-COHORT-DISCOVERY-RELEASE-001; MODULE-LIVE-COHORT-TO-FORGE-001 | MIXED | resolve-route / Catalog dereference | false |
| What feature or data exists at decision time? | SEM-MARKET-DATA-FEATURES | ACTIVE-FACTORY-MARKET-FEATURE-SURFACE→CONFIG-FACTORY-V1-COMMON-MARKET-FEATURE-SURFACE-001; ACTIVE-MARKET-DATA-AWARENESS→CONFIG-MARKET-CONTEXT-DEFINITION-001 | MIXED | resolve-route / Catalog dereference | false |
| What needs my attention today? | SEM-OWNER-DAILY-ATTENTION | ACTIVE-OWNER-DAILY-ATTENTION→DOC-OWNER-ATTENTION-AND-CHANGE-FEED-001; DOC-OWNER-ATTENTION-AND-CHANGE-FEED-001; MODULE-OWNER-DAILY-ATTENTION-001 | MIXED | resolve-route / Catalog dereference | false |
| What lifecycle objects currently exist? | SEM-OWNER-LIFECYCLE | ACTIVE-OWNER-LIFECYCLE-PROJECTION→CONFIG-OWNER-LIFECYCLE-PROJECTION-001; ACTIVE-RESEARCH-LIFECYCLE-WORKBENCH→DOC-RESEARCH-LIFECYCLE-WORKBENCH-001; DOC-OWNER-LIFECYCLE-PROJECTION-001; DOC-RESEARCH-LIFECYCLE-WORKBENCH-001; DOC-EXPERIMENT-EVIDENCE-DECISION-001 | MIXED | resolve-route / Catalog dereference | false |
| Has this mechanism been tested? | SEM-PRIOR-WORK | MODULE-FACTORY-V1-RESEARCH-STORE-001; REGISTRY-DECISIONS-NEGATIVE-RESULTS-001; REGISTRY-GLOBAL-TRIAL-LEDGER-001 | SCIENTIFIC | resolve-route / Catalog dereference; recipes QUERY-HFIC-EXACT-RELATED-PRIOR-001, QUERY-HYPOTHESIS-FAST-LANE-SEARCH-PRIOR-WORK-001, QUERY-HFIC-SESSION-BY-SEARCH-KEY-001, QUERY-HFIC-PENDING-SESSION-001 | false |
...
| Where is the Factory VPS? | SEM-REMOTE-OPS-RECOVERY | ACTIVE-FACTORY-REMOTE-OPERATIONS→CONFIG-FACTORY-REMOTE-OPERATIONS-V1-1-001; DOC-FACTORY-REMOTE-HOST-001; DOC-FACTORY-UNATTENDED-OPERABILITY-001; DOC-SYSTEM-OPERABILITY-SURFACE-001 | MIXED | EXTERNAL_GATED_READBACK via DOC-FACTORY-REMOTE-HOST-001, DOC-FACTORY-UNATTENDED-OPERABILITY-001 | false |
