...
RECOVERY_ROUTE = {
    ...
    "CAMPAIGN_SUCCESSOR_REQUIRED": "docs/operator/FACTORY_LIFECYCLE_COLLECTOR.md",
    "ROLLOVER_IMMUTABLE_PROOF_UNAVAILABLE": "docs/operator/FACTORY_LIFECYCLE_COLLECTOR.md",
}
...
def _next_action_for(code: str) -> str:
    ...
    if code == "CAMPAIGN_SUCCESSOR_REQUIRED":
        return "REPAIR_CAMPAIGN_SUCCESSOR_CONTINUITY"
