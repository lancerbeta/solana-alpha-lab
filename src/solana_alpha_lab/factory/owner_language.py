...
SURFACE_COPY = {
    ...
    "ECONOMICS": {
        ...
        "drawdown": "Model-PnL drawdown",
        "streak": "Серия убытков",
        "fee_coverage": "Покрытие modeled fees",
        "fcf": "Owner FCF",
        "netreturn": "NetReturn",
        "reconciled": "Reconciled economics",
    ...
    "SYSTEM": {
        ...
        "durability": "Backup / off-host / archive",
        "deploy": "Deploy identity",
        "alerting": "Incident / alert",
        "coverage": "Покрытие",
        "next": "Следующее безопасное действие",
        "machine": "Точные machine-значения",
        "process": "Процесс",
