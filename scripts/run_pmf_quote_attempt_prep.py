#!/usr/bin/env python3
"""Offline PMF quote attempt-prep binder. No provider calls."""
...
def main() -> int:
    ...
    runtime = {
        "schema": "smial.pmf-quote-attempt-prep.runtime-receipt",
        "schema_version": "1.0",
        "receipt_id": "EVIDENCE-PMF-QUOTE-ATTEMPT-PREP-001",
        "atom_id": ATOM_ID,
        **result,
    }
    acceptance = {
        "schema": "smial.pmf-quote-attempt-prep.acceptance",
        "schema_version": "1.0",
        "acceptance_id": "EVIDENCE-PMF-QUOTE-ATTEMPT-PREP-001",
        "atom_id": ATOM_ID,
        "as_of": "2026-08-17",
        "owner_decision": "FREEZE_OFFLINE_ATTEMPT_CONTRACT_NOT_ATTEMPTED",
