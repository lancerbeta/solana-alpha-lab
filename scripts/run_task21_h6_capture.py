"""Run separately authorized TASK-21 H6 foreground capture."""
...
from solana_alpha_lab.task21_h6_foreground_capture import (  # noqa: E402
    ...
    try:
        receipt = run_h6_foreground_capture(
            gate=(
                ...
                else Task21H6ExecutionGate(args.authority)
            ),
            repo_root=ROOT,
        ...
        print("TASK21_H6_CAPTURE: FAIL")
        print(f"ERROR_TYPE: {type(exc).__name__}")
        print(f"ERROR_CODE: {_safe_code(exc)}")
        return 1
    print("TASK21_H6_CAPTURE: " + str(receipt["status"]))
