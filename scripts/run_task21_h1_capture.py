"""Run separately authorized TASK-21 H1 foreground capture."""
...
from solana_alpha_lab.task21_h1_foreground_capture import (  # noqa: E402
...
def main() -> int:
    ...
    try:
        receipt = run_h1_foreground_capture(
            gate=Task21H1ExecutionGate(args.authority),
            repo_root=ROOT,
        ...
        print("TASK21_H1_CAPTURE: FAIL")
        print(f"ERROR_TYPE: {type(exc).__name__}")
        print(f"ERROR_CODE: {_safe_code(exc)}")
        return 1
    print("TASK21_H1_CAPTURE: " + str(receipt["status"]))
