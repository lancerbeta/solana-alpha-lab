#!/usr/bin/env python3
"""Run one foreground valuation-liquidity divergence PIT window after owner authorization."""
...
RAW_ROOT = ROOT / "local/early_valuation_liquidity_divergence_confirmation"
EVIDENCE_ROOT = ROOT / "docs/evidence/early_valuation_liquidity_divergence_confirmation"
...
def capture_envelope(*, observation_id: str, observed_at: str, body_sha256: str) -> dict[str, str]:
    payload = {
        ...
        "schema": "smial.early-valuation-liquidity-divergence-confirmation.capture-envelope",
        "schema_version": "1.0",
    }
...
def attempt_reservation_document(*, started_at: str, policy_sha256: str) -> dict[str, object]:
    payload = {
        ...
        "provider_requests": 0,
        "schema": "smial.early-valuation-liquidity-divergence-confirmation.attempt-reservation",
        "schema_version": "1.0",
...
def _load_policy() -> dict[str, object]:
    ...
    validate_divergence_policy(loaded, root=ROOT)
    return loaded
...
def run_capture(
    *,
    ...
    validate_divergence_policy(selected_policy, root=ROOT)
    ...
    receipt["receipt_id"] = "EVIDENCE-EARLY-VALUATION-LIQUIDITY-DIVERGENCE-RUNTIME-001"
...
def _owner_next_for_terminal(terminal: str) -> str:
    if terminal == "CLOSE_VALUATION_LIQUIDITY_DIVERGENCE_FAMILY":
        return "FAMILY_CLOSED_NO_SHADOW_NO_THRESHOLD_SEARCH"
    if terminal == "EARN_ONE_CONFIRMATORY_FRESH_OOS":
        return "OWNER_DECIDES_WHETHER_A_LATER_CONFIRMATORY_OOS_DESERVES_A_NEW_CONTRACT"
    return "INVALID_EVIDENCE_REPLAN_DO_NOT_OPEN_WINDOW_B_OR_SHADOW"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Scientific terminals: CLOSE_VALUATION_LIQUIDITY_DIVERGENCE_FAMILY | "
