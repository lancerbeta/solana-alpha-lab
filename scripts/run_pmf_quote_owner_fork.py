#!/usr/bin/env python3
"""Offline PMF quote owner-fork binder. No provider calls."""
...
def main() -> int:
    ...
    runtime = {
        "schema": "smial.pmf-quote-owner-fork.runtime-receipt",
        "schema_version": "1.0",
        "receipt_id": "EVIDENCE-PMF-QUOTE-OWNER-FORK-001",
        "atom_id": ATOM_ID,
        **result,
    }
    acceptance = {
        "schema": "smial.pmf-quote-owner-fork.acceptance",
        "schema_version": "1.0",
        "acceptance_id": "EVIDENCE-PMF-QUOTE-OWNER-FORK-001",
        "atom_id": ATOM_ID,
        "as_of": "2026-08-17",
        "owner_decision": "NAME_MISSING_TOUCH_FILLABLE_FEE_FACTS_NO_EXECUTE",
