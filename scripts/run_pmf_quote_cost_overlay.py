#!/usr/bin/env python3
"""Offline PMF quote-cost overlay binder. No provider calls."""
...
def main() -> int:
    ...
    runtime = {
        "schema": "smial.pmf-quote-cost-overlay.runtime-receipt",
        "schema_version": "1.0",
        "receipt_id": "EVIDENCE-PMF-QUOTE-COST-OVERLAY-001",
        "atom_id": ATOM_ID,
        **result,
    }
    acceptance = {
        "schema": "smial.pmf-quote-cost-overlay.acceptance",
        "schema_version": "1.0",
        "acceptance_id": "EVIDENCE-PMF-QUOTE-COST-OVERLAY-001",
        "atom_id": ATOM_ID,
        "as_of": "2026-08-17",
        "owner_decision": "BIND_PMF_QUOTE_COST_OVERLAY_FILLABLE_NOT_EVIDENCED",
